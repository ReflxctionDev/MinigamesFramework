 ...
 */
package io.github.revxrsal.minigames.packet;
...
public class TitlePacket extends AbstractPacket {
    ...
    public TitlePacket(PacketContainer packet) {
        super(packet, TYPE);
    }

    public TitlePacket setAction(TitleAction value) {
        handle.getTitleActions().write(0, value);
        return this;
    }

    public TitlePacket setTitle(WrappedChatComponent value) {
