...
import io.github.revxrsal.minigames.message.CommentedConfiguration;
...
public class MessageManager {
    ...
    public MessageManager(MinigamePlugin plugin) {
        messagesFile = plugin.getFileManager().embedded("messages.yml");
